...
local all_ak74ext = {
	...
	"wpn_fps_ass_ak_stamp_545_md_ak74",
	"wpn_fps_ass_ak_stamp_545_md_ak74m",
	"wpn_fps_ass_ak_stamp_545_md_ak105"
}
...
if attach_tables then
	for _, md_id in pairs(attach_tables.Barrel_Extensions) do
		if self.parts[md_id] then
			table.insert(all_ak74ext, md_id)
		end
	end
...
for id, st_id in pairs (all_ar15stock) do
	self.wpn_fps_ass_ak_stamp_545.override[st_id] = {depends_on = "stock_adapter"}
	self.wpn_fps_ass_ak_stamp_545.override[st_id] = {a_obj = "a_s_ar15"}
end
...
for id, o_id in pairs(all_ak545sight) do
	self.wpn_fps_ass_ak_stamp_545.adds[o_id] = {"wpn_fps_ass_ak_stamp_545_om_tula"}
end
for id, md_id in pairs(all_ak74ext) do
	self.parts.wpn_fps_ass_ak_stamp_545_ba_ak105.override[md_id] = {a_obj="a_ns_ak105"}
end
--=========================--
--          STANCE         --
--=========================--
